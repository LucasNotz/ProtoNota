...
public class TelaRegistro extends JFrame {
	...
	private JLabel passwordLabel = new JLabel("Nova Senah");
	...
	public TelaRegistro(String mainFolderPath) {
		...
		passwordConfirm.setBounds(100,40,200,20);
		passwordLabel.setBounds(10,10,100,20);
		passwordConfirmLabel.setBounds(10,40,100,20);
		createPass.setBounds(10,70,200,20);
		exitProcess.setBounds(10,100,200,20);
		caution.setBounds(10,130,400,300);
